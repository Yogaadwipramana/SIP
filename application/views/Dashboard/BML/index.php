          ...
          <table id="example" class="table table-bordered table-hover nowrap" style="width:100%">
            ...
            <tbody>
              ...
              foreach ($data as $value) :
                ...
                $data_negara  = $this->db->query("select id_negara_asal,nama_negara from ref_negara_asal where id_negara_asal = '$value->negara_asal' ")->row();
