      ...
      <div class="row row-lg">
        ...
        <div class="col-sm-12 col-md-12">
          ...
          <div class="example-wrap">
            ...
            <div class="example">
              <form class="form-horizontal" action="<?php echo base_url(); ?>PengeluaranRBB/add_action_realisasi" method="post" enctype="multipart/form-data" onsubmit="return approveAlert();" id="myForm">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" autocomplete="off" placeholder="Negara Asal"  name="negara_asal" class="form-control" value="<?= $data_estimasi->negara_tujuan ?>" required="required">
                  ...
                  <tbody id="myTablePK">
                    ...
                    ?>
                      ...
                      <tr style="text-align: center;">
                        ...
                        <td><input type="text" id="harga_satuan_get<?= $no ?>" name="harga_satuan_get<?= $no ?>" class="form-control" value="<?= number_format($value_result->harga, 2, ",", "."); ?>" disabled="disabled"></td>
                  ...
                  <tbody id="myTablePK">
                    ...
                    ?>
                      ...
                      <tr style="text-align: center;">
                        ...
                        <!-- <td><input type="text" id="harga_satuan_real<?= $no ?>" name="harga_satuan_real<?= $no ?>" class="form-control classHarga" value="<?= number_format($value_result->harga, 2, ",", "."); ?>" onkeyup="myFunctionKeyup(<?= $no ?>)"></td>
                        ...
                        <td><input type="text" id="harga_satuan_real<?= $no ?>" name="harga_satuan_real<?= $no ?>" class="form-control classHarga" value="<?= $value_result->harga; ?>" onkeyup="myFunctionKeyup(<?= $no ?>)"></td>
                        <td><input type="text" autocomplete="off" id="hasil_real_show<?= $no ?>" value="<?= $value_result->nilai_barang; ?>" name="hasil_real_show<?= $no ?>" class="form-control classTotalHarga" readonly="readonly"><input type="text" autocomplete="off" id="hasil_real<?= $no ?>" name="hasil_real<?= $no ?>" value="<?= $value_result->nilai_barang ?>" style="display: none;"></td>
                        <td><input type="text" autocomplete="off" id="biaya_kurs_real<?= $no ?>" value="<?= $value_result->biaya_kurs; ?>" name="biaya_kurs_real<?= $no ?>" class="form-control classBiayaKurs" onkeyup="myFunctionKeyupKurs(<?= $no ?>)"><a href="https://www.bi.go.id/id/statistik/informasi-kurs/transaksi-bi/default.aspx" target="_blank"> Cek Nilai Biaya Kurs</a></td>
                        <td><input type="text" autocomplete="off" id="total_calculate<?= $no ?>" value="<?= $value_result->total_calculate; ?>" name="total_calculate<?= $no ?>" class="form-control classTotalBiayaKurs" readonly="readonly"><input type="text" autocomplete="off" id="hasil_get<?= $no ?>" name="hasil_get<?= $no ?>" value="<?= $value_result->nilai_barang ?>" class="form-control" style="display: none;" value=""></td>
                      </tr>
                      <input style="display: none;" type="text" value="<?= $no++ ?>">
                    <?php
