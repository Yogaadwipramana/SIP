        ...
        <div id="Estimasi" class="tabcontent">
            ...
            <tbody>
              ...
              foreach ($data_estimasi as $value) :
                ...
                $count_gudang = $this->db->query("select count(terminal_tank) as total from barang_keluar_estimasi where no_transaksi = '$value->no_transaksi' ")->row();                  
              ...
              ?>
                <tr>
                  ...
                  <td><?= date('d-m-Y', strtotime($value->pengeluaran_kargo_tgl)); ?> <?= $value->pengeluaran_kargo_time; ?></td>
                  ...
                  <?php if($count_gudang->total > 1){ 
                      $loop_gudang = $this->db->query("select terminal_tank from barang_keluar_estimasi where no_transaksi = '$value->no_transaksi' ")->result();
                  ?>
                      <td><?php
                  ...
                  <?php }elseif($value->status == 2){ ?>  
                          ...
                          <?php }else{?>
                            <td>Data Telah Di Reject, Silahkan Input Kembali</td>
                          <?php } ?>
                </tr>
              <?php
              endforeach;
