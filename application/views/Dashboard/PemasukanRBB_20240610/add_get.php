              ...
              <form class="form-horizontal" action="<?php echo base_url(); ?>PemasukanRBB/add_action_get" method="post" enctype="multipart/form-data">
                ...
                <thead>
                  <tr>
                    ...
                    <td class="JudulHeadr" style="padding-left: 5px; width: 14%; border-bottom: 1px solid black;">Barang</td>
                    <td class="JudulHeadr" style="padding-left: 5px; width: 12%; border-bottom: 1px solid black;">Qty</td>
                    <!-- <td class="JudulHeadr" style="padding-left: 5px; width: 12%; border-bottom: 1px solid black;">Satuan</td> -->
                    <!-- <td class="JudulHeadr" style="padding-left: 5px; width: 10%; border-bottom: 1px solid black;">Lokasi Tujuan Terminal</td> -->
                    <td class="JudulHeadr" style="padding-left: 5px; width: 12%; border-bottom: 1px solid black;">Gudang</td>
                    <td class="JudulHeadr" style="padding-left: 5px; width: 12%; border-bottom: 1px solid black;">Mata Uang</td>
                    <td class="JudulHeadr" style="padding-left: 5px; width: 12%; border-bottom: 1px solid black;">Harga Satuan Barang (origin price)</td>
                    <td class="JudulHeadr" style="padding-left: 5px; width: 12%; border-bottom: 1px solid black;">Total Nilai Barang (origin price)</td>
                    <td class="JudulHeadr" style="padding-left: 5px; width: 12%; border-bottom: 1px solid black;">Biaya Kurs</td>
                    <td class="JudulHeadr" style="padding-left: 5px; width: 12%; border-bottom: 1px solid black;">Calculate Biaya Kurs (covertion price)</td>
                  </tr>
                ...
                <tbody id="myTablePK" >
                  ...
                  <tfoot>
                       <tr style="text-align: center;">
                        ...
                        <td class="JudulHeadr" style="padding-left: 5px;"></td>
                        <td class="JudulHeadr" style="padding-left: 5px; width: 12%;"><input type="text" id="totalshowqty" class="form-control"></td>
                        <td class="JudulHeadr" style="padding-left: 5px;"></td>
                        <td class="JudulHeadr" style="padding-left: 5px; width: 12%;"></td>
                        <td class="JudulHeadr" style="padding-left: 5px; width: 12%;"><input type="text" id="totalshowharga" class="form-control" ></td>
                        <td class="JudulHeadr" style="padding-left: 5px; width: 12%;"><input type="text" id="totalshowTH" class="form-control" ></td>
                        <td class="JudulHeadr" style="padding-left: 5px; width: 12%;"><input type="text" id="totalshowBK" class="form-control" ></td>
                        <td class="JudulHeadr" style="padding-left: 5px; width: 12%;"><input type="text" id="totalshowCBK" class="form-control" ></td>
                  </tr>
                  </tfoot>
