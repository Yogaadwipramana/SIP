          ...
          ?>
            <tr>
                ...
                <td>
                                ...
                                <!-- <a style="text-decoration:none; text-align:center;" class="btn btn-block btn-success" id="approve-btn" href="<?php echo base_url('Approve/approve_barang_keluar/'.$value->no_transaksi.'/'.$value->jenis_keluar);?>">
...
<script type="text/javascript">
    document.getElementById('approve-btn').addEventListener('click', function(event) {
        event.preventDefault(); // Mencegah tautan default bekerja
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Jika dikonfirmasi, redirect ke URL yang ditentukan
