                  ...
                  <table id="example" class="table table-bordered table-hover nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      foreach ($data_estimasi as $value) :
                        ...
                        $count_gudang = $this->db->query("select count(terminal_tank) as total from barang_masuk_estimasi where no_transaksi = '$value->no_transaksi' ")->row();
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?= date('d-m-Y', strtotime($value->penerimaan_kargo_tgl)); ?> <?= date('h:i:s', strtotime($value->penerimaan_kargo_time)); ?></td>
                          ...
                          <?php if($count_gudang->total > 1){ 
                              $loop_gudang = $this->db->query("select terminal_tank from barang_masuk_estimasi where no_transaksi = '$value->no_transaksi' ")->result();
                          ?>
                              <td><?php
                  ...
                  <table id="example2" class="table table-bordered table-hover nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      foreach ($data_realisasi as $value) :
                        ...
                        $data_dokumen   = $this->db->query("select dokumen from ref_dokumen where id_dokumen = '$value->jenis_doc' ")->row();
                        $data_negara_asal = $this->db->query("select nama_negara from ref_negara_asal where id_negara_asal = '$value->negara_asal' ")->row();
                        $count_gudang = $this->db->query("select count(terminal_tank) as total from barang_masuk_estimasi where no_transaksi = '$value->no_transaksi' ")->row();
                      ...
                      ?>
                        <tr>
                          ...
                          <?php }else{?>
                            <td><?= $nama_tank; ?></td>
                          <?php } ?>
                          <td><?= $data_negara_asal->nama_negara; ?></td>
