      ...
      <div class="row row-lg">
        ...
        <div class="col-sm-12 col-md-12">
          ...
          <div class="example-wrap">
            ...
            <div class="example">
              <form class="form-horizontal" action="<?php echo base_url(); ?>PemasukanRBB/add_action_get" method="post" enctype="multipart/form-data" onsubmit="return approveAlert();" id="myForm">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select data-plugin="select2" name='jenis_pemasukan' id="jenis_pemasukan" class="form-control" required="required">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" autocomplete="off" placeholder="No Dokumen Pabean" name="no_dokumen_pabean" class="form-control" value="<?= $dataGet->no_dokumen_pabean ?>" required="required">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="date" id="tgl_dokumen_pabean" name="tgl_dokumen_pabean" class="form-control" placeholder="Tanggal lahir" value="<?= $dataGet->tgl_dokumen_pabean ?>" required="required">
                  </div>
                </div>
