...
class Approve  extends CI_Controller{
    ...
    public function review_bk($id_get){
        ...
        $data_realisasi_result    = $this->model_global->edit_data($where_no_transaksi, 'barang_keluar_realisasi')->result();
        ...
        $data = array(
            ...
            'data_estimasi'     => $data_estimasi,
            'data_estimasi_result'     => $data_estimasi_result,
            'data_realisasi_result'     => $data_realisasi_result,
            'terminal2'         => $terminal2,
            'tank2'             => $tank2,
            'kategori_barang'   => $kategori_barang,
            'satuan'            => $satuan,
    ...
    public function reject_barang_keluar($id_bk){
        if($this->session->userdata('name_user') and $this->session->userdata('username')){
            $this->db->query("insert barang_keluar_realisasi_log select * from barang_keluar_realisasi where no_transaksi = '$id_bk' ");
            $this->db->query("insert barang_keluar_estimasi_log select * from barang_keluar_estimasi where no_transaksi = '$id_bk' ");
